...
class Menu extends Admin
{
        ...
        { 
                $db = new DataBase();
                $menus=$db->select('SELECT * FROM menus WHERE parent_id IS NULL ORDER BY id')->fetchAll();
        ...
        {
                $db = new DataBase();
               $a= $db->insert('menus',array_keys(array_filter($request)),array_filter($request));
        ...
        public function update($request, $id)
        {
                ...
                require_once(BASE_PATH . '/template/admin/menus/update.php');
        }
