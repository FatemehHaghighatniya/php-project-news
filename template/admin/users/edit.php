...
<section class="row my-3">
    <section class="col-12">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="password" name="password" placeholder="*** ..." value="" disabled>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="permission" id="permission" class="form-control" required autofocus>
                        ...
                        <option value="admin" <?php if($user['permission'] == 'user') echo 'selected'?>>Admin</option>
                </select>
        </div>
