    ...
    <section class="table-responsive">
        <table class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <a role="button" class="btn btn-sm btn-success text-white" href="<?=url('admin/user/permission/' . $user['id'])?>"><?=($user['permission'] == 'user') ? 'click to be admin' : 'click not to be admin' ?></a>
